...
import { Eye, CheckCircle2, XCircle, MoreVertical } from "lucide-react";
          ...
          {isPending && onApprove && (
            <>
              ...
              <button
                ...
                className="flex items-center gap-2 w-full px-3 py-2 body-text text-zinc-600 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-green-600 transition-colors cursor-pointer"
              >
