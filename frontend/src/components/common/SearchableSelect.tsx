...
export interface SelectSearchBoxProps extends Omit<
      ...
      <div className={`space-y-1.5 ${containerClassName}`}>
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className={`w-full h-10 flex items-center justify-between px-3.5 py-2 body-text bg-zinc-50 dark:bg-zinc-800/60 border rounded-xl transition-all text-left ${
              error
