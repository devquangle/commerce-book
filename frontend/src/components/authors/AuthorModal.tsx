...
import { useWikipedia } from "@/modules/admin/authors/hooks/useWikipedia";
...
import type { AuthorRequest, AuthorResponse } from "@/modules/admin/authors/types/author.type";
