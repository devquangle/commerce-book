...
import { type PromotionResponse } from "@/modules/shop/promotions/types/promotion.type";

interface PromotionActionMenuProps {
...
export const PromotionActionMenu: React.FC<PromotionActionMenuProps> = ({
  item,
  onDelete,
  onEdit,
  onView,
