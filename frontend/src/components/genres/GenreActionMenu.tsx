...
import { type GenreResponse } from "@/modules/admin/genres/types/genre.type";

interface GenreActionMenuProps {
  item: GenreResponse;
  onEdit: (genre: GenreResponse) => void;
  onDelete: (genre: GenreResponse) => void;
}

export const GenreActionMenu: React.FC<GenreActionMenuProps> = ({ item, onEdit, onDelete }) => {
