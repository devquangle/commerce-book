...
import { type PublisherResponse } from "@/modules/admin/publishers/types/publisher.type";
...
export const PublisherActionMenu: React.FC<PublisherActionMenuProps> = ({ item, onEdit, onDelete }) => {
