...
export const AuthorMobileCard: React.FC<AuthorMobileCardProps> = ({
  ...
  if (authors.length === 0) {
    return (
      <div className="md:hidden p-8 text-center bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 font-medium">
  ...
  return (
    <div className="md:hidden space-y-3">
      {authors.map((author) => (
        <div
          key={author.id}
          className="p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-3 shadow-sm"
        >
