...
const AdminProductListPage = lazy(
  () => import("@/modules/admin/products/pages/AdminProductListPage"),
);
const AdminProductDetailPage = lazy(
  () => import("@/modules/admin/products/pages/AdminProductDetailPage"),
);
const AdminStores = lazy(() => import("@/modules/admin/pages/AdminStores"));
const AdminSeriesPage = lazy(
  () => import("@/modules/admin/series/AdminSeriesPage"),
);
const AdminGenrePage = lazy(
  () => import("@/modules/admin/genres/AdminGenrePage"),
);
const AdminAuthorPage = lazy(
  () => import("@/modules/admin/authors/AdminAuthorPage"),
);
const AdminPublisherPage = lazy(
  () => import("@/modules/admin/publishers/AdminPublisherPage"),
);
const AdminAnalytics = lazy(
  () => import("@/modules/admin/pages/AdminAnalytics"),
);
const AdminReportsProducts = lazy(
  () => import("@/modules/admin/pages/AdminReportsProducts"),
);
const AdminReportsStores = lazy(
    ...
    <AdminLayout>
      <Suspense fallback={<Spinner message="Loading admin panel..." />}>
        <Routes>
          ...
          />
          <Route
            path={ADMIN_PATH.PRODUCTS_DETAIL}
          ...
          <Route
            path={ADMIN_PATH.PUBLISHERS}
            element={<AdminPublisherPage />}
          />
          <Route path={ADMIN_PATH.ANALYTICS} element={<AdminAnalytics />} />
          <Route
            path={ADMIN_PATH.REPORTS_PRODUCTS}
            element={<AdminReportsProducts />}
          />
          <Route
            path={ADMIN_PATH.REPORTS_STORES}
            element={<AdminReportsStores />}
          />
