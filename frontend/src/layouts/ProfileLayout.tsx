    ...
    <div className="grid grid-cols-12 gap-5 my-5">
      ...
      <div className="col-span-12 md:col-span-3">
        <div className="card-custom h-full p-3! md:p-4!">
          <div className="hidden md:flex items-center gap-3 p-2 mb-4 border-b border-gray-100 dark:border-zinc-800">
          ...
          <div className="flex flex-row md:flex-col gap-2 overflow-x-auto no-scrollbar whitespace-nowrap">
            <NavLink
              ...
              className={({ isActive }) =>
                `block px-4 py-2 rounded-lg transition-colors body-text ${isActive ? "bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 font-medium" : "text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-800/50"}`
              }
            >
              Hồ sơ cá nhân
            </NavLink>
